      ...
      <section className="hero-section">
        ...
        <div className="w-full max-w-5xl mx-auto flex items-center justify-center relative z-10 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center text-center space-generous max-w-4xl">
            ...
            <h1 className="text-hero font-bold leading-tight animate-fade-in max-w-4xl" style={{animationDelay: "0.2s"}}>
...
const LatestContent = () => {
  ...
  return (
    <div className="section-container bg-green-50 dark:bg-green-950/30">
          ...
          <div>
            ...
            <div className="grid-layout">
              {latestBlogs.map(blog => (
                <Card key={blog.id} className="overflow-hidden border-green-100 dark:border-green-900 hover:shadow-md transition-shadow card-hover">
          ...
          <div>
            ...
            <div className="grid-layout">
              {latestRecipes.map(recipe => (
                <Card key={recipe.id} className="overflow-hidden border-green-100 dark:border-green-900 hover:shadow-md transition-shadow card-hover">
                  <div className="h-48 overflow-hidden">
                    <img 
