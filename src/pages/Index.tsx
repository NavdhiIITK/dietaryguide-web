        ...
        <div className="content-wrapper">
          <div className="flex justify-between items-center mb-16 space-comfortable">
            <div>
              ...
              <p className="text-foreground/70 text-base text-left">
Expert tips, science-backed nutrition guidance, and transformative health strategies—curated to empower your wellness journey</p>
            </div>
