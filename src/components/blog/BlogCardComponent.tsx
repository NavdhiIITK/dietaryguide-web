        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between text-xs text-muted-foreground pt-2 border-t border-border/50">
            <div className="flex items-center gap-2">
              <img
                src={post.author?.avatarUrl || 'https://github.com/ANVEAI/nutriverse-3d-guide-78/blob/main/Untitled%20design.png?raw=true'}
                alt={post.author?.name || 'Author'}
                className="w-5 h-5 rounded-full"
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  target.src = 'https://github.com/ANVEAI/nutriverse-3d-guide-78/blob/main/Untitled%20design.png?raw=true';
                }}
              />
